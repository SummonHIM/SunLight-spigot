...
public class V1_15_R1 extends TabPacketManager {
    ...
    public V1_15_R1(@NotNull SunLight plugin, @NotNull TabManager tabManager) {
    ...
    public void constructTeam() {
        ...
        for (Player playerReceiver : online) {
            playerTeams.forEach((playerTeam, teamInfo) -> {
                ...
                pCreate.getChatComponents().write(1, WrappedChatComponent.fromText(teamPrefix));
                pCreate.getChatComponents().write(2, WrappedChatComponent.fromText(teamSuffix));
